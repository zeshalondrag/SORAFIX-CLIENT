...
export default function ClientDashboard() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      // Берём последние 5 заявок (сортировка по дате, если нужно)
    ...
    >
      ...
      <View style={styles.statsRow}>
        <StatCard
          ...
          label="Новая заявка"
          description="Создайте заявку на обслуживание"
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Мои последние заявки</Text>
